...
if st.button("✨ Generate AI-Based Job Profile & Variable Score"):
    if not (selected and len(selected) > 0):
        ...
        try:
            ...
            result = supabase.rpc("ambil_employee_detail_r2", {"selected_ids": selected_ids}).execute()
            ...
            if result.data:
                ...
                desired_cols = [
                    ...
                    "baseline_score",
                    "tv_weight", "tgv_weight","tv_match_rate","user_score","tv_match_rate","tgv_match_rate","final_match_rate"
                ]
